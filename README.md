...
- `com.cinebh.api.entities` - JPA Entities representing the database schema.
...
3. **Configure Local Environment:** Open `src/main/resources/application-local.yml` and update the `username` and `password` fields with your local PostgreSQL credentials.
